...
function FormCategoria() {
  ...
  return (
    <div className="container flex flex-col items-center justify-center mx-auto min h-[60vh]">
      ...
      >
        ...
        <button
          className="rounded text-slate-100 bg-indigo-600 
          hover:bg-blue-500 w-1/2 py-2 mx-auto flex justify-center"
          type="submit"
        >
          {isLoading ?
            <RotatingLines
